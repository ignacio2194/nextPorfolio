...
const Projects = () => {
  ...
  return (
    <div className="container mt-3" id="projects">
      ...
      <div
        className={` ${styles.CardsContainer} row justify-content-center align-items-center text-center gap-4 mb-5`}
      >
