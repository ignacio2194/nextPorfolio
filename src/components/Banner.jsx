  ...
  return (
    <div>
      <div className={`${styles.bannerContainer}`} id="home">
        ...
        <div
          className={`${styles.information} container   d-flex justify-content-center align-items-center gap-2`}
        >
          <div
            className={`${styles.information_aboutMe} container d-inline w-100 `}
          >
            <div
              className={`${styles.information_aboutMe_title}  text-center text-light`}
            >
              <h2>{t("aboutme-title.hi-im")}</h2>
              <span>
                <AiOutlineArrowDown
                  className={`${styles.informationIcon} mb-2 `}
                />
              </span>
            </div>
            <motion.div className="information_aboutMe_text  text-justify ">
              <h5>{t("aboutme-text.hi-im")}</h5>
            </motion.div>
          </div>
