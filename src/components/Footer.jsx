...
const Footer = () => {
  ...
  useEffect(() => {
    setDate({ dia: hoy, mes: mesActual, año: añoActual });
  }, []);
  return (
    <div className={`${styles.footer} container-fluid `}>
      <div className={styles.contact}>
        <div className="row">
          ...
          <div className={`${styles.contactIcon}  ml-4 col-md-12 col-xs-12 col-sm-12 text-center `}>
            <a
        ...
        <div className={`${styles.lastUpdated}  d-flex justify-content-between align-items-center m-0 m-auto`}>
          <span className="text-light last-updated-text">
            {" "}
            {`   Last updated: ${date.dia}/${date.mes}/${date.año}`}
          </span>
          <span className="text-light ">This portfolio was created on Next.js</span>
        </div>
